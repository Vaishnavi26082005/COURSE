...
function UpdateCourse() {
  ...
  return (
    <div>
      <div className="min-h-screen py-10 bg-gradient-to-r from-blue-950 to-blue-300">
        <div className="max-w-2xl mx-auto p-6 border rounded-lg shadow-lg mb-8">
