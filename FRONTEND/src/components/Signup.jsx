      ...
      <div className="h-screen container mx-auto flex  items-center justify-center text-white">
        ...
        <div className="bg-gray-900 p-8 rounded-lg shadow-lg w-[500px] m-8 md:m-0 mt-20">
          ...
          <p className="text-center text-gray-400 mb-6">
            Just Signup To Get Some Skills!
          </p>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              className="w-full bg-blue-500 hover:bg-blue-300 hover:text-black hover:scale-105  py-3 px-6 rounded-md transition duration-300"
            >
              Signup
            </button>
          </form>
